...
namespace Todoly.Tests.API.Steps.Project
{
    ...
    public class PostStepDefinitions : CommonSteps
    {
        ...
        [When(
            @"the user sends a POST request to the API endpoint with a valid JSON or XML payload"
        )]
        ...
        [Then(
            @"the response should have a status code of ""(.*)"" and the new project should be added to the database and the response should contain the details of the newly created project"
        )]
        public void Thentheresponseshouldhaveastatuscodeofandthenewprojectshouldbeaddedtothedatabaseandtheresponseshouldcontainthedetailsofthenewlycreatedproject(
            string statusCode
        )
        {
        ...
        [When(
            @"the user sends a POST request to the API endpoint with a JSON or XML payload that is missing required fields"
        )]
        ...
        [Then(
            @"the response should have a status code of ""(.*)"" and a error message indicating missing fields"
        )]
        public void Thentheresponseshouldhaveastatuscodeofandaerrormessageindicatingmissingfields(
            string statusCode
        )
        {
            RestResponse response = (RestResponse)_scenarioContext["Response"];
